...
import com.capdev.middleware.MiddlewareApp;
import com.capdev.middleware.domain.Service;
import com.capdev.middleware.repository.ServiceRepository;
import com.capdev.middleware.web.rest.errors.ExceptionTranslator;
...
import static com.capdev.middleware.web.rest.TestUtil.createFormattingConversionService;
...
public class ServiceResourceIT {
    ...
    private static final String DEFAULT_SERVICETYPE = "AAAAAAAAAA";
    private static final String UPDATED_SERVICETYPE = "BBBBBBBBBB";
    ...
    public void createService() throws Exception {
        ...
        assertThat(testService.getServicetype()).isEqualTo(DEFAULT_SERVICETYPE);
    }
    ...
    public void getAllServices() throws Exception {
        ...
        restServiceMockMvc.perform(get("/api/services?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].servicetype").value(hasItem(DEFAULT_SERVICETYPE)));
    }
    ...
    public void getService() throws Exception {
        ...
        restServiceMockMvc.perform(get("/api/services/{id}", service.getId()))
            ...
            .andExpect(jsonPath("$.servicetype").value(DEFAULT_SERVICETYPE));
    }
    ...
    public void updateService() throws Exception {
        ...
        assertThat(testService.getServicetype()).isEqualTo(UPDATED_SERVICETYPE);
    }

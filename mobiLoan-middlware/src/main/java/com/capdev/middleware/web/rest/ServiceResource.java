...
public class ServiceResource {
     ...
     */
    @PostMapping("/post")
    public ResponseEntity<Map<String, Object>> post(@RequestBody Map<String, Object> service) throws URISyntaxException {
        log.debug("REST request to save Service : {}", service);
        if (service.get("customerCode") == null) {
            throw new BadRequestAlertException("field Customer Code mandatory", ENTITY_NAME, "idexists");
        }

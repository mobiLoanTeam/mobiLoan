...
import { CustomerUpdateComponent } from 'app/entities/onBoarding/customer/customer-update.component';
import { CustomerService } from 'app/entities/onBoarding/customer/customer.service';
import { Customer } from 'app/shared/model/onBoarding/customer.model';
  ...
  describe('Customer Management Update Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [MobiLoanGatewayTestModule],

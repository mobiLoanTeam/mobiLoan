package com.capdev.onboarding.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("onBoarding");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("onBoarding");
        ...
        config.getMapConfigs().put("com.capdev.onboarding.domain.*", initializeDomainMapConfig(jHipsterProperties));
